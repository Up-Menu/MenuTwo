      ...
      createTheme({
        ...
        colors: {
          ...
          secondary: {
            lighter:
              mode === 'dark'
                ? alpha(themeColors.secondary, 0.1)
                : themeColors.white,
            light:
              mode === 'dark'
                ? alpha(themeColors.secondary, 0.3)
                : themeColors.white,
            main: mode === 'dark' ? themeColors.secondary : themeColors.white,
            dark:
              mode === 'dark'
                ? darken(themeColors.secondary, 0.2)
                : themeColors.white
          },
          primary: {
        ...
        sidebar: {
          ...
          menuItemIconColorActive:
            colors.layout.sidebar.menuItemIconColorActive,
        ...
        palette: {
          ...
          mode,
          primary: {
            light: mode === 'dark' ? colors.primary.light : colors.primary.dark,
          ...
          text: {
            primary: mode === 'dark' ? colors.alpha.black[100] : '#000000d4',
            secondary: mode === 'dark' ? colors.alpha.black[70] : '#000000d4',
            disabled: mode === 'dark' ? colors.alpha.black[50] : '#000000d4'
          },
          background: {
        ...
        components: {
          ...
          MuiListItemText: {
            styleOverrides: {
              root: {
                margin: 0,
                color: mode === 'dark' ? colors.alpha.black[100] : '#000000d4'
              }
            }
          },
          MuiListItemButton: {
          ...
          MuiLink: {
            defaultProps: {
              underline: 'hover',
              color: mode === 'dark' ? themeColors.secondary : '#000000d4'
            }
          },
          MuiLinearProgress: {
            styleOverrides: {
